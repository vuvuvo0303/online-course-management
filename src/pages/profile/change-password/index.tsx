    ...
    <div className="flex ">
      <div className="w-2/3 py-8 ">
        <div className="flex justify-center mb-6">
          <span className="text-5xl font-bold">Change Password</span>
        </div>
      ...
      <div className="w-1/3  bg-amber-50 flex flex-col justify-end">
        <div className="flex justify-center mb-16">
          {" "}
          <div className="flex flex-col ">
            {" "}
            <span className="text-3xl font-bold">Don’t worry .</span>
            <span className="text-3xl font-bold">we’ll help you</span>
          </div>
        </div>

        <img src={changepass} width={400} />
      </div>
    </div>
  );
};
