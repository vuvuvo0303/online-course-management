...
const CourseCard: React.FC<CourseCardProps> = ({ course }) => {
    return (
        <div className="flex flex-row w-full lg:h-[24rem] bg-gray shadow-md rounded-lg p-5">
            ...
            <div className="pl-5 flex flex-col text-white flex-grow">
                ...
                <div className="space-y-2 flex-grow">
                    ...
                    <div><span>Last update:</span> {new Date(course.updated_at).toLocaleDateString()}</div>
            ...
            <div className="ml-4 flex flex-row text-white">
