    ...
    <main className={styles.courses_container}>
      ...
      <div className={styles.component_margin}>
        <div className="mt-0 mx-0 mb-6">
          ...
          <Tabs className="mt-5" defaultActiveKey="1" items={tabsItems} />
        </div>
      </div>
      ...
      <section className="mb-1.5">
        <div className="mb-2.5">
          <div className="flex justify-between mb-4 mt-7">
                ...
                <div className={styles.form_control}>
                  <div className="flex-1 relative">
                    <select
                      ...
                      id="form-group"
                    >
                      <option className="bg-white" value="popularity selected">
                        Most popular
                      </option>
                      <option className="bg-white" value="highest-rated">
                        Highest Rated
                      </option>
            ...
            <span className={styles.item_count}>{pagination.total.toLocaleString()} results</span>
          </div>
          ...
          <div className="flex w-full">
            ...
            <div className={isSidebarOpen ? "w-3/4" : "w-full"}>
