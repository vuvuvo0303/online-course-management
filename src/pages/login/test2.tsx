...
// import axiosInstance from "../login/axiosInstance"; // Correct import path for axiosInstance
...
//     try {
//       const decodedToken: any = jwtDecode(credentialResponse.credential as string);
//       const googleId = decodedToken.sub; // Google ID
//       const role = "student"; // or "instructor", based on your logic

//       // Store the Google ID token in local storage
//       localStorage.setItem("google_id", credentialResponse.credential);

//       // Register the user
//       await axiosInstance.post('/api/users/google', { googleId, role });

//       // Login the user
//       const loginResponse = await axiosInstance.post('/api/auth/google', { googleId });
