      ...
      {loading ? (
        ...
        <div className="w-full max-w-2xl bg-white p-8 rounded shadow">
          <Breadcrumb className="py-2">
            ...
            <Breadcrumb.Item href={`/instructor/manage-course/${courseId}/manage-session/${sessionId}/lecture`}>
              Manage Lecture
            </Breadcrumb.Item>
            <Breadcrumb.Item>{sessionId ? "Update Session" : "Create Session"}</Breadcrumb.Item>
          </Breadcrumb>
