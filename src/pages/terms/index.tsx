...
const Terms = () => {
    ...
    return (
        <div className='mx-10 px-10 relative'>
            <div className='w-full'>
                ...
                <div>
                    <p>FLearn's mission is to improve lives through learning. We make it possible for anyone, anywhere, to create and share educational content (trainers) and access that educational content to learn (students). We consider this marketplace model to be the best way to deliver valuable educational content to users. We need rules to ensure our platform and services are safe for you, us, and our community of students and instructors. These Terms apply to all of your activities on the FLearn website, the FLearn mobile app, the TV app, our APIs, and other related services (
                        <strong>"Service"</strong>
                        )
                    </p>
                    <p>If you post a course on the FLearn platform, you must also agree to Terms for Instructors. We also provide details about our processing of personal data of students and lecturers in Privacy policy of us</p>
                    <p>Our website and applications cause communications about your web and application browsing activities and application usage to be sent from you to third parties that provide services to FLearn. By using our Services, you agree to these communications.</p>
                    ...
                    <h2 id='section3' className={styles.categories}>3. Payments, Offers and Refunds</h2>
                    <div className={styles.alertBanner}>
                        <p>When paying, you agree to use a valid payment method. If you're not satisfied with the content, FLearn offers a 30-day refund or offer on most content purchases.</p>
                    </div>
                    <p>We will occasionally run promotions and sales for our content, where certain content will be made available at a discounted price for a certain period of time. The price applicable to that content will be the price at the time you complete your purchase of the content (at checkout). Any recommended prices for specific content may differ between the time you log in to your account and the price for unregistered or unlogged in users, due to some of our promotions. I'm just for new users.</p>

                    <p>You agree to pay for the content you purchase and you authorize us to charge your debit or credit card or process such charges by other payment methods (such as Boleto, SEPA, direct debit or mobile wallet). FLearn partners with payment service providers to offer you the most convenient payment methods in your country and to keep your payment information secure. We may update your payment method using information provided by our payment service provider.</p>
                    ...
                    <h2 id='section4' className={styles.categories}>4. Content and behavior rules</h2>
                    <div className={styles.alertBanner}>
                        <p>You may only use FLearn for lawful purposes. You are responsible for all content you post on our platform. You should ensure that the reviews, questions, posts, courses and other content you upload comply with our Trust & Safety Guidelines and the law, and respect intellectual property rights. wisdom of others. We may ban your account for repeated or serious violations. Please notify us if you believe someone is violating your copyright on our platform.</p>
                    </div>
                    <p>You may not access or use the Services or create an account for illegal purposes. Your use of the Services and your conduct on our platform is subject to applicable national or local laws or regulations in your country of residence. You are solely responsible for your knowledge of and compliance with the laws and regulations that apply to you.</p>

                    <p>If you are a student, the Services allow you to ask questions of instructors about courses or other content in which you are enrolled and to post reviews of the content. For certain content, instructors may invite you to submit content as “homework” or an exam. Don't post or send anything that isn't yours.</p>

                    <p>If you are an instructor, you can submit content to post on the platform, and you can also contact students enrolled in your course or other content. In both cases, you must comply with the law and respect the rights of others: you may not post any courses, questions, answers, reviews or other content that violates local laws or regulations. applicable local or national law in your country of residence. You are solely responsible for any courses, content and actions you post or take through the platform and Services and their consequences. Make sure you understand all applicable copyright restrictions</p>

                    <h2 id='section5' className={styles.categories}>5. FLearn's rights to the content you post</h2>
                    <div className={styles.alertBanner}>
                        <p>You maintain ownership of the content you post to our platform, including your courses. We are permitted to share your content with anyone else through any media, including promoting it through advertising on other websites.</p>
                    </div>

                    <p>When you post content, comments, questions, reviews, and when you send us ideas and suggestions for new features or improvements, you authorize FLearn to use and share this content with any anyone, distribute and promote such content on any platform and in any media and to modify or edit as it sees fit.</p>

                    <p>In legal terms, by submitting or posting content on or through the platforms, you grant us a worldwide, non-exclusive, royalty-free license (with the right to sublicense) to use, copy, reproduce, process, adapt, modify, post, transmit, display and distribute your content (including your name and likeness) in any and all media or method of distribution (existing or later developed). This includes providing your content to other companies, organizations or individuals that partner with FLearn to syndicate, broadcast, distribute or post the content in other media, as well as using the content your content for marketing purposes. You also waive any rights of privacy, publicity or other rights of a similar nature applicable to all such uses, to the extent permitted under applicable law. You represent and warrant that you have all necessary rights, power and authority to authorize us to use any content you submit. You also agree to the use of your content as mentioned above without any compensation to you.</p>


                    <h2 id='section6' className={styles.categories}>6. Use FLearn at your own risk</h2>
                    <div className={styles.alertBanner}>
                        <p>Anyone can use FLearn to create and post content as well as instructors and we enable instructors and students to interact to teach and learn. Like other platforms where people can post content and interact, mistakes can happen and you use FLearn at your own risk.</p>
                    </div>
                    ...
                    <p>By using the Services, you may be exposed to content that you consider offensive, indecent or objectionable. FLearn has no responsibility to separate such content from you and is not liable for your access to or enrollment in any courses or other content, to the extent permitted under applicable law. This also applies to any content related to health, fitness, and fitness. You acknowledge the risks and dangers inherent in the nature of this type of content and by accessing such content, you choose to voluntarily accept those risks, including the risk of illness, physical injury body, disability or death. You are solely responsible for the choices you make before, during and after accessing the content.</p>

                    <p>When you interact directly with a student or instructor, you must exercise caution when sharing these types of personal information. Although we limit the types of information that instructors can request from students, we do not control the actions that students and instructors take with the information they collect from others. other users on the platform. For your own safety, you should not share your email or other personal information about yourself.</p>

                    <p>We do not hire or employ instructors, and are not responsible or liable for any interactions between instructors and students. We are not responsible for disputes, claims, losses, injuries or damages of any kind that may arise from or in connection with the conduct of instructors or students.</p>
                    ...
                    <h2 id='section7' className={styles.categories}>7. FLearn Permissions</h2>
                    <div className={styles.alertBanner}>
                        <p>We own the FLearn platform and Services, including the website, current or future applications and services, and things like logos, APIs, code, and content created by our employees. You may not tamper with them or use them without permission.</p>
                    </div>

                    <p>All rights, title and interest in and to the FLearn platform and Services, including current or future websites, applications, APIs, databases and content that its employees or Our partners submit or make available through our Services (but excluding content provided by instructors and students) are and will remain the exclusive property of FLearn and its licensors. FLearn. Our platforms and services are protected by copyright, trademark, and other laws of both the United States and foreign countries. There are no rights granted to you to use the FLearn name or any FLearn trademarks, logos, domain names, and other distinctive brand features. Any feedback, comments or suggestions you may provide regarding FLearn or the Services are entirely voluntary and we will be free to use such feedback, comments or suggestions as we see fit and without have any obligations to you.</p>

                    <h2 id='section8' className={styles.categories}>8. Subscription package terms</h2>
                    <p>As part of your subscription to a Subscription, you will receive a limited, non-exclusive, non-transferable license from us to access and view the content contained in that Subscription through the Services. Except for the granting of lifetime access licenses, the terms contained in the “Content Enrollment and Lifetime Access” section above will apply to students enrolled through a Subscription Plan.</p>

                    <p>We reserve the right to revoke any license to use content in our Subscription Plans for legal or policy reasons at any time and in our sole discretion, for example if we no longer has the right to provide content through the Subscription Plan. Additional information about our revocation rights is provided in the “Content Enrollment and Lifetime Access” section.</p>

                    <p>You can start your subscription with a free trial. The free trial period for your subscription will be indicated during the registration process. FLearn determines free trial eligibility at our sole discretion and may limit access, eligibility, or free trial length. We reserve the right to terminate your free trial period and suspend your subscription if we determine that you are not eligible.</p>

                    <p>You must provide a payment method to subscribe to a Subscription Plan. By subscribing to a Subscription Plan and providing your payment information at checkout, you grant us and our payment providers permission to process payment for then applicable fees. via the payment method we keep on file for you. At the end of each subscription billing period, we will automatically renew your subscription for the same term and process your payment method for payment of then-applicable fees.</p>

                    <p>If we are unable to process payment through the payment method we have on file for you, or if you submit a dispute regarding charges charged to your payment method and chargebacks granted, we may suspend or terminate your subscription.</p>

                    <p>We reserve the right to change Subscription Plans or adjust prices for our Services at our sole discretion. Any changes in price or to your subscription plan will be effective upon our notice to you, unless otherwise required by applicable law.</p>

                    <h2 id='section9' className={styles.categories}>9. Other legal terms</h2>
                    <div className={styles.alertBanner}>
                        <p>These Terms are like any other contract, containing boring but important legal terms that protect us from a myriad of things that could happen and clarify the legal relationship between us and you.</p>
                    </div>

                    <p>You agree that by registering for, accessing, or using our Services, you are entering into a legally binding contract with FLearn. If you do not agree to these Terms, please do not register for, access or use any of our Services.</p>

                    <p>If you are an instructor accepting these Terms and using our Services on behalf of a company, organization, government or other legal entity, you represent and warrant that you are authorized to do so. the above actions.</p>

                    <p>If you behave in a way that puts us in legal trouble, we may take legal action against you. You agree to indemnify, defend (if required by us) and hold harmless FLearn, our group companies and their officers, directors, suppliers, partners and agents us against any third party claim, demand, loss, damage or expense (including reasonable attorneys' fees) arising out of: (a) content you post or submit; (b) your use of the Services; (c) your violation of these Terms or (d) your violation of any third party rights. Your indemnification obligation will survive termination of these Terms and your use of the Services.</p>

                    <h2 id='section10' className={styles.categories}>10. Dispute resolution</h2>
                    <div className={styles.alertBanner}>
                        <p>If there is a dispute, our Support Team is always happy to help resolve the issue. If this doesn't work and you live in the United States or Canada, you may choose to sue in small claims court or file a claim in binding individual arbitration; You may not sue in another court or participate in a class, non-individual action against us.</p>
                    </div>

                    <p>FLearn commits to making every effort to resolve disputes with FLearn users without filing a formal legal complaint. If a problem arises between the two parties, you and FLearn agree to first work diligently and in good faith to reach a solution that is fair and equitable to both parties using the dispute resolution process Not officially required are described below. Sometimes, a third party may be necessary to help resolve a dispute between two parties. This dispute resolution agreement limits how these disputes will be resolved.</p>
                    ...
                    <p>Your continued use of our Services after changes take effect means you accept those changes. Any revised Terms will supersede all prior Terms.</p>

                    <h2 id='section12' className={styles.categories}>12. How to contact us</h2>
                    <p>The best way to contact us is to contact our support team</p>
                    <p className='mb-5'>Thank you for teaching and learning with us!</p>
                </div>
            </div>
            <ScrollToTopButton />
        </div>
