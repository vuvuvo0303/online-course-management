...
const AdminManageUsers: React.FC = () => {
  ...
  const handleDelete = useCallback(async (_id: string, email: string) => {
    try {
  ...
  const addNewUser = useCallback(async (values: Student) => {
    try {
      setLoading(true);
  ...
  const sortColumn = useCallback((columnKey: keyof Student) => {
