...
export const API_REVIEW_PROFILE_INSTRUCTOR =
...
export const API_GET_PURCHASE_BY_INSTRUCTOR =
...
export const API_INSTRUCTOR_GET_SUBSCRIPTIONS =
  "/api/subscription/search-for-instructor";
export const API_INSTRUCTOR_OR_STUDENT_GET_SUBSCRIBER =
